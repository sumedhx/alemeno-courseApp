...
const AddCourse = () => {
  ...
  // Random thumbnail from Picsum with fixed dimensions (400x250 recommended)
    ...
    <div className="add-course-container">
        <div className="add-course-form">
            ...
            <form className="add-course-form" onSubmit={handleSubmit}>
                ...
                <input type="text" placeholder="Pre-requisites" value={prerequisites} onChange={(e) => setPrerequisites(e.target.value)} required />
                <textarea placeholder="Syllabus" value={syllabus} onChange={(e) => setSyllabus(e.target.value)} required />
                <input type="url" placeholder="YouTube/Video Link" value={videoLink} onChange={(e) => setVideoLink(e.target.value)} />
